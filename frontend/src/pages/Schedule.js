...
function Schedule() {
    ...
    try {
      ...
      const mockEvents = [
        ...
        },
        {
          ...
          end: new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate() + 2, 13, 0),
  ...
  const handleStatusUpdate = async (appointmentId, newStatus) => {
    try {
      ...
      // Mostrar mensagem de sucesso (poderia ser implementado com um toast)
  ...
  const renderMonthView = () => {
    ...
    return (
      <div className="month-view">
        <p>Visualização mensal não implementada nesta versão.</p>
      </div>
    );
  };
        ...
        <div className="schedule-header">
          ...
          <div className="schedule-controls">
            <div className="view-controls">
              ...
              >
                <i className="fas fa-calendar-alt me-1"></i> Mês
              </button>
            </div>
        ...
        <div className="schedule-footer">
          <div className="footer-content">
            ...
            <div className="footer-actions">
              {isProvider && (
                <Link to="/create-request" className="btn btn-success me-2">
